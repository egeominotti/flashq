...
export function Settings() {
  ...
  useEffect(() => {
    if (settings) {
      ...
      console.log('[Settings] SQLite enabled:', settings.sqlite?.enabled);
      console.log('[Settings] S3 enabled:', settings.s3_backup?.enabled);
  ...
  const handleSaveS3 = async () => {
    ...
    console.log('[S3 Save] Sending payload:', payload);
    const result = await api.saveS3Settings(payload);
    console.log('[S3 Save] Response:', result);
    if (result.ok) {
      setS3Status('success');
      // Wait a bit then refetch to ensure server processed the request
      setTimeout(async () => {
        const newSettings = await refetch();
        console.log('[S3 Save] New settings after refetch:', newSettings.data);
      }, 500);
    } else {
      setS3Status('error');
  ...
  const restoreBackup = async (key: string) => {
    if (!confirm(`Restore from "${key}"? This will replace all current data.`)) return;
    setIsRestoring(true);
    try {
  ...
  const handleSaveSqlite = async () => {
    ...
    console.log('[SQLite Save] Sending payload:', payload);
    const result = await api.saveSqliteSettings(payload);
    console.log('[SQLite Save] Response:', result);
    if (result.ok) {
      setSqliteStatus('success');
      setTimeout(async () => {
        const newSettings = await refetch();
        console.log('[SQLite Save] New settings after refetch:', newSettings.data);
      }, 500);
    } else {
      ...
      <header className="page-header">
        <div>
          ...
          <Text className="page-subtitle">
            Configure server, persistence, and backup settings
          </Text>
        </div>
        ...
        <TabPanels>
            ...
            <Grid numItemsSm={1} numItemsLg={2} className="gap-6">
              ...
              <Card className="settings-card">
                <Flex alignItems="center" className="mb-4">
                  ...
                  <Badge className="ml-auto" color={connectionStatus === 'success' ? 'emerald' : connectionStatus === 'error' ? 'rose' : 'zinc'}>
                ...
                <div className="space-y-4">
                  ...
                  <Flex className="gap-2">
                    <Button size="xs" variant="secondary" icon={TestTube} onClick={handleTestConnection} loading={connectionStatus === 'testing'}>
                      Test
                    </Button>
              ...
              <Card className="settings-card">
                <Flex alignItems="center" className="mb-4">
                  ...
                  <Badge className="ml-auto" color="emerald">Online</Badge>
                </Flex>
                ...
                <Flex className="gap-2">
                  ...
                  <Button size="xs" variant="secondary" color="rose" icon={Power} onClick={handleShutdownServer}>
                    Shutdown
                  </Button>
                </Flex>
              </Card>
              ...
              <Card className="settings-card">
                ...
                <Grid numItemsSm={2} className="gap-3 mb-4">
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <NumberInput value={queueMaxAttempts} onValueChange={setQueueMaxAttempts} min={1} max={100} />
                  </div>
                  <div className="form-group">
                ...
                <Button size="xs" icon={Save} onClick={handleSaveQueueDefaults} loading={queueSaving}>
                  Save Defaults
                </Button>
              </Card>
              ...
              <Card className="settings-card">
                ...
                <Grid numItemsSm={2} className="gap-3 mb-4">
                  <div className="form-group">
                    ...
                    <NumberInput value={maxCompletedJobs} onValueChange={setMaxCompletedJobs} min={1000} step={1000} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Max Results</label>
                    <NumberInput value={maxJobResults} onValueChange={setMaxJobResults} min={100} step={100} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Interval (sec)</label>
                    <NumberInput value={cleanupInterval} onValueChange={setCleanupInterval} min={10} step={10} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">History Size</label>
                    <NumberInput value={metricsHistorySize} onValueChange={setMetricsHistorySize} min={100} step={100} />
                  </div>
                </Grid>
                ...
                <>
                  <Grid numItemsSm={2} numItemsLg={4} className="gap-4 mb-4">
                    ...
                    <div className="form-group">
                      ...
                      <NumberInput value={sqliteCacheSize} onValueChange={setSqliteCacheSize} min={16} max={1024} step={16} />
                    </div>
                    <div className="form-group">
                      ...
                      <Flex className="mt-2 items-center gap-2">
                        ...
                        <Text className="text-sm text-zinc-400">{sqliteSynchronous ? 'NORMAL' : 'OFF'}</Text>
                      </Flex>
                    </div>
                  </Grid>
                  ...
                  <Button size="xs" icon={Save} onClick={handleSaveSqlite} loading={sqliteStatus === 'saving'}>
                    Save Configuration
                  </Button>
                  ...
                  {settings?.sqlite?.enabled && (
                    <>
                      ...
                      <Flex alignItems="center" justifyContent="between" className="mb-3">
                        ...
                        <Flex className="gap-2">
                          <Button size="xs" variant="secondary" icon={Download} onClick={handleExportSqlite} loading={isExporting}>
                            Export
                          </Button>
                          <label className="inline-flex">
                            ...
                            />
                            <Button size="xs" variant="secondary" icon={Upload} loading={isSqliteRestoring} onClick={(e) => {
                      ...
                      <div className="settings-grid compact">
                        ...
                        <div className="setting-item">
                          ...
                          <Badge color="blue">{sqliteStats?.processing_jobs?.toLocaleString() || '0'}</Badge>
                        </div>
                        <div className="setting-item">
                      ...
                      {sqliteStats?.async_writer_enabled && (
                        <>
                          <Divider className="my-4" />
                          <Flex alignItems="center" justifyContent="between" className="mb-3">
                            <Text className="text-sm font-medium text-zinc-300">Async Writer (High Performance Mode)</Text>
                            <Badge color="emerald">Active</Badge>
                          </Flex>
                          <div className="settings-grid compact mb-4">
                            <div className="setting-item">
                          ...
                          <Button size="xs" icon={Save} onClick={handleSaveAsyncWriter} loading={asyncWriterSaving}>
                            Update Async Writer
                          </Button>
                        </>
                      )}
          ...
          <TabPanel>
            <Card className="settings-card">
              ...
              {s3Enabled ? (
                <>
                  <Grid numItemsSm={2} numItemsLg={3} className="gap-4 mb-4">
                    <div className="form-group">
                      <label className="form-label">Endpoint URL *</label>
                      <TextInput placeholder="https://s3.amazonaws.com" value={s3Endpoint} onChange={(e) => setS3Endpoint(e.target.value)} />
                    </div>
                    <div className="form-group">
                      <label className="form-label">Bucket Name *</label>
                      <TextInput placeholder="my-flashq-backups" value={s3Bucket} onChange={(e) => setS3Bucket(e.target.value)} />
                    </div>
                    <div className="form-group">
                      <label className="form-label">Region</label>
                      <TextInput placeholder="auto" value={s3Region} onChange={(e) => setS3Region(e.target.value)} />
                    </div>
                    <div className="form-group">
                      <label className="form-label">Access Key *</label>
                      <TextInput placeholder="AKIAIOSFODNN7EXAMPLE" value={s3AccessKey} onChange={(e) => setS3AccessKey(e.target.value)} />
                    </div>
                    <div className="form-group">
                      <label className="form-label">Secret Key *</label>
                      <TextInput type="password" placeholder="Secret key" value={s3SecretKey} onChange={(e) => setS3SecretKey(e.target.value)} />
                    </div>
                    <div className="form-group">
                      <label className="form-label">Interval (sec)</label>
                  ...
                  <Flex className="gap-2 mb-6">
                    <Button size="xs" variant="secondary" icon={TestTube} onClick={handleTestS3} loading={s3Status === 'testing'} disabled={!s3Endpoint || !s3Bucket || (!s3AccessKey && !settings?.s3_backup?.enabled) || (!s3SecretKey && !settings?.s3_backup?.enabled)}>
                      Test Connection
                    </Button>
                    <Button size="xs" icon={Save} onClick={handleSaveS3} loading={s3Status === 'saving'} disabled={!s3Enabled && (!s3Endpoint || !s3Bucket || !s3AccessKey || !s3SecretKey)}>
                      Save
                    </Button>
                  </Flex>
                  {settings?.s3_backup?.enabled && !s3AccessKey && (
                    <Text className="text-xs text-zinc-500 mb-4">Credentials already saved. Leave blank to keep existing.</Text>
                  )}
                  ...
                  <Flex alignItems="center" justifyContent="between" className="mb-4">
                    ...
                    <Flex className="gap-2">
                      ...
                      <Button size="xs" variant="secondary" icon={RefreshCw} onClick={loadBackups} loading={isLoadingBackups}>
                        Refresh
                      </Button>
                    </Flex>
                  </Flex>
                      ...
                      <TableBody>
                        {backups.map((backup) => (
                          <TableRow key={backup.key}>
                            <TableCell><span className="font-mono text-white">{backup.key.split('/').pop()}</span></TableCell>
                            <TableCell className="text-right"><span className="font-mono text-zinc-400">{formatBytes(backup.size)}</span></TableCell>
                            <TableCell><span className="text-zinc-400">{backup.last_modified ? formatRelativeTime(backup.last_modified) : '-'}</span></TableCell>
                            <TableCell className="text-right">
                              <Button size="xs" variant="secondary" icon={Download} onClick={() => restoreBackup(backup.key)} loading={isRestoring}>
                                Restore
                              </Button>
                            </TableCell>
                          </TableRow>
          ...
          <TabPanel>
            <Card className="settings-card">
              ...
              <Text className="text-sm font-medium text-zinc-300 mb-3">Security Status</Text>
              <div className="settings-grid compact">
                <div className="setting-item">
          ...
          <TabPanel>
            <Card className="settings-card danger-zone">
              ...
              <div className="space-y-3">
                <Flex alignItems="center" justifyContent="between" className="p-3 bg-zinc-800/50 rounded-lg">
                  <div>
                    <Text className="font-medium">Clear All Queues</Text>
                    <Text className="text-xs text-zinc-500">Remove all pending jobs</Text>
                  </div>
                  <Button size="xs" variant="secondary" color="rose" icon={Trash2} onClick={handleClearQueues}>
                    Clear
                  </Button>
                </Flex>
                ...
                <Flex alignItems="center" justifyContent="between" className="p-3 bg-zinc-800/50 rounded-lg">
                  <div>
                    ...
                    <Text className="text-xs text-zinc-500">Remove all failed jobs</Text>
                  </div>
                  <Button size="xs" variant="secondary" color="rose" icon={Trash2} onClick={handleClearDlq}>
                    Clear
                  </Button>
                </Flex>
                ...
                <Flex alignItems="center" justifyContent="between" className="p-3 bg-zinc-800/50 rounded-lg">
                  <div>
                    <Text className="font-medium">Clear Completed</Text>
                    <Text className="text-xs text-zinc-500">Remove completed job records</Text>
                  </div>
                  <Button size="xs" variant="secondary" color="rose" icon={Trash2} onClick={handleClearCompleted}>
                    Clear
                  </Button>
                </Flex>
                ...
                <Flex alignItems="center" justifyContent="between" className="p-3 bg-zinc-800/50 rounded-lg">
                  <div>
                    ...
                    <Text className="text-xs text-zinc-500">Clear historical data</Text>
                  </div>
                  <Button size="xs" variant="secondary" color="rose" icon={RotateCcw} onClick={handleResetMetrics}>
                    Reset
                  </Button>
                </Flex>
              </div>
